...
const InventoryReport = () => {
  ...
  const fetchStaffList = async () => {
    try {
      const res = await axios.get('https://mini-fully-system.vercel.app/api/users/staff');
  ...
  const fetchStaffInventory = async (staffId) => {
    try {
      setLoading(true);
      const res = await axios.get(`https://mini-fully-system.vercel.app/api/staff-inventory/${staffId}`);
