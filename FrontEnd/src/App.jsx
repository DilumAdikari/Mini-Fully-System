...
const MainAppContent = () => {
  ...
  const loadSystemData = async () => {
    ...
    try {
      const [grnRes, staffRes, depRes] = await Promise.all([
        axios.get('https://mini-fully-system.vercel.app/api/grn'),
  ...
  const loadNotifications = async () => {
    ...
    try {
      const res = await axios.get(`https://mini-fully-system.vercel.app/api/notifications/${user.uid}`);
  ...
  const handleMarkAsRead = async (id) => {
    try {
      await axios.patch(`https://mini-fully-system.vercel.app/api/notifications/read/${id}`);
  ...
  const handleMarkAllAsRead = async () => {
    ...
    try {
      await Promise.all(unreadNotifs.map(n => axios.patch(`https://mini-fully-system.vercel.app/api/notifications/read/${n._id}`)));
